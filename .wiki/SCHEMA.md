...
<div class="wiki-backlinks">
  ...
  <ul class="wiki-backlinks-list">
    <li><a href="/2025/09/12/LearningNote/2025-09-12-RAG检索增强生成/">RAG检索增强生成</a></li>
  </ul>
</div>
```
...
Hexo permalink 配置为 `:year/:month/:day/:title/`，其中 `:title` 来自 **_posts/ 下的相对路径**（含分类目录+文件名）。
因此 Wiki 页面的 Hexo URL 格式为：
