...
[![文档](https://img.shields.io/badge/文档-在线查阅-48bfe3?style=flat-square)](https://mornikar.github.io/Mornikar/docs/)
...
详细步骤：[完整安装部署指南](https://mornikar.github.io/Mornikar/docs/INSTALL/)
...
| 文档 | 说明 |
|:-----|:-----|
| [安装部署](https://mornikar.github.io/Mornikar/docs/INSTALL/) | 从零部署自己的博客 |
| [系统架构](https://mornikar.github.io/Mornikar/docs/PROJECT/) | 目录结构、组件关系、主题定制 |
| [AI 助手](https://mornikar.github.io/Mornikar/docs/AI_CHAT/) | Wiki AI 对话助手使用指南 |
| [日常维护](https://mornikar.github.io/Mornikar/docs/MAINTENANCE/) | Wiki 编辑、Dify 同步、Tailscale |
| [Giscus 留言](https://mornikar.github.io/Mornikar/docs/GISCUS/) | 基于 GitHub Discussions 的评论系统 |
| [故障排查](https://mornikar.github.io/Mornikar/docs/TROUBLESHOOTING/) | 常见问题与解决方案 |
| [Wiki 格式规范](https://mornikar.github.io/Mornikar/docs/MIGRATION/) | frontmatter、WikiLink、分类映射 |
| [分支说明](https://mornikar.github.io/Mornikar/docs/BRANCHES/) | source/main 分支关系与工作流程 |
...
| 文档站 | https://mornikar.github.io/Mornikar/docs/ |
| 搜索 | https://mornikar.github.io/Mornikar/pagefind/ |
